...
class UpdateZoneDriverRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'partner_type' => 'required|in:independent,third-party',
            'agency_branch_id' => 'required_if:partner_type,third-party|nullable|exists:agency_branches,id',
            'agency_registration_number' => 'required_if:partner_type,third-party|nullable|string|max:100',
    ...
    public function driverPayload(): array
    {
        return [
            ...
            'agency_branch_id' => $this->input('partner_type') === 'third-party' ? (int) $this->input('agency_branch_id') : null,
            'agency_registration_number' => $this->input('partner_type') === 'third-party' ? $this->input('agency_registration_number') : null,
