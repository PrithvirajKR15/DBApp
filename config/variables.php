...
return [
  ...
  "templateName" => env('APP_NAME', 'Delivery Boy'),
  "templateSuffix" => env('APP_NAME', 'Delivery Boy') . " Dashboard",
  ...
  "ogTitle" => env('APP_NAME', 'Delivery Boy') . " Dashboard by Kenland IT Solutions Pvt Ltd",
